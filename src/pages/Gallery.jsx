...
const Gallery = () => {
  const [cardWidth, setCardWidth] = useState("320px");
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (width >= 1200) {
        setCardWidth("272px"); // 320 * 0.85
      } else if (width <= 600) {
        setCardWidth("320px");
      } else {
        // 600 ~ 1200 사이에서 선형 보간
        const scale = 1 - ((width - 600) / (1200 - 600)) * 0.15;
        setCardWidth(`${320 * scale}px`);
      }
    };
  ...
  return (
    ...
    >
      <Row className="justify-between p-20">
        <Col className="items-center" style={{ width: cardWidth }}>
          <GalleryCard
